      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            {/* WhatsApp CTA */}
            <motion.a
              href="https://wa.me/5511999999999?text=Ol%C3%A1%21+Tenho+interesse+em+criar+minha+presen%C3%A7a+digital.+Podemos+conversar%3F"
              target="_blank"
              rel="noopener noreferrer"
              className="relative group inline-flex items-center justify-center gap-3 px-8 py-5 rounded-full bg-[#7ab648] text-[#0f1a08] font-black text-lg overflow-hidden"
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.97 }}
              animate={{
                boxShadow: [
                  "0 0 30px rgba(122,182,72,0.35)",
                  "0 0 60px rgba(122,182,72,0.65)",
                  "0 0 30px rgba(122,182,72,0.35)",
                ],
              }}
              transition={{
